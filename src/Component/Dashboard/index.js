...
class Event extends Component {
  ...
  ExpandMore(id) {
    superagent
      .get(`http://3.19.26.106:8080/events/${id}`)
      .set("Content-Type", "application/json")
      .then(res => {
        const name = res.body.event.name;
        const date = res.body.event.date;
        const venue = res.body.event.venue;
  ...
  handleData(e, id) {
    ...
    superagent
      .patch(`http://3.19.26.106:8080/events/${id}`)
  ...
  handleDelete(id) {
    ...
    superagent
      .del(`http://3.19.26.106:8080/events/${id}`)
      .set("x-auth", this.getAuthenticationToken())
      .then(res => {
        console.log(res);
      })
  ...
  componentDidMount() {
    superagent
      .get('http://3.19.26.106:8080/dashboard')
      .set("x-auth", this.getAuthenticationToken())
      .set("Content-Type", "application/json")
      .then(res => {
