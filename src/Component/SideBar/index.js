...
import day2 from "../../2-day.png";
import day3 from "../../3-day.png";
import day4 from "../../4-day.png";
...
class SideBar extends Component {
  ...
  handleLogout = () => {
    superagent
      .del('http://3.19.26.106:8080/logout')
        ...
        >
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav">
              ...
              <li className="nav-item pt-1" style={{marginLeft: '0.3rem'}}>
